...
mkdir $HOME/UTNFRA_SO_2do_Parcial_Chavarri/RTA_Examen_${TIMESTAMP}
touch $HOME/UTNFRA_SO_2do_Parcial_Chavarri/RTA_Examen_${TIMESTAMP}/Punto_A.sh
touch $HOME/UTNFRA_SO_2do_Parcial_Chavarri/RTA_Examen_${TIMESTAMP}/Punto_B.sh
touch $HOME/UTNFRA_SO_2do_Parcial_Chavarri/RTA_Examen_${TIMESTAMP}/Punto_C.sh
touch $HOME/UTNFRA_SO_2do_Parcial_Chavarri/RTA_Examen_${TIMESTAMP}/Punto_D.sh
